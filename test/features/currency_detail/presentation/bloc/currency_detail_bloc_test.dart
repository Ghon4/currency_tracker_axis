...
class _MockGetSevenDayHistory extends Mock implements GetSevenDayHistory {}

class _MockGetCachedRates extends Mock implements GetCachedRates {}

class _MockGetLatestRatesWithChange extends Mock
    implements GetLatestRatesWithChange {}

void main() {
  late _MockGetSevenDayHistory getHistory;
  late _MockGetCachedRates getCached;
  late _MockGetLatestRatesWithChange getLatest;
  ...
  setUp(() {
    getHistory = _MockGetSevenDayHistory();
    getCached = _MockGetCachedRates();
    getLatest = _MockGetLatestRatesWithChange();
  });
    ...
    blocTest<CurrencyDetailBloc, CurrencyDetailState>(
      ...
      expect: () => [
        ...
        const CurrencyDetailFullError(
          currencyCode: 'USD',
          message: 'Could not load rate for USD.',
        ),
      ],
      verify: (_) {
