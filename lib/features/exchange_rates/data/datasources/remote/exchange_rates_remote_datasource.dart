...
abstract class ExchangeRatesRemoteDataSource {
  ...
  Future<ExchangeRatesResponse> getHistoricalRates(DateTime date);
}
...
class ExchangeRatesRemoteDataSourceImpl
  ...
  ExchangeRatesRemoteDataSourceImpl(this._client);

  final DioClient _client;

  @override
  Future<ExchangeRatesResponse> getLatestRates() async {
    try {
      final response = await _client.get<Map<String, dynamic>>(
        AppConstants.latestRatesUrl(),
      );
  ...
  @override
  Future<ExchangeRatesResponse> getHistoricalRates(DateTime date) async {
